...
- **`models/regime_model.py`** — Pre-break OLS (2015–2021) vs post-break OLS (2022–2025) with Fed-focused event days (policy, crisis facilities, independence headlines) excluded; exports a multi-page PDF under `outputs/`.
